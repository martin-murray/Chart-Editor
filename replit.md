...
- **Annotation Font Size Control**: Price Chart and Comparison Chart annotation edit dialogs include font size controls (−/+ buttons) with real-time preview. Sizes range from 10px to 32px in 2px increments, default 14px. Font size is persisted per annotation.
